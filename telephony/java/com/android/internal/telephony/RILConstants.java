...
*/
    ...
    int RIL_REQUEST_SIM_GET_ATR = 137;
    int RIL_REQUEST_CAF_SIM_OPEN_CHANNEL_WITH_P2 = 138;
    int RIL_REQUEST_GET_ADN_RECORD = 139;
    int RIL_REQUEST_UPDATE_ADN_RECORD = 140;
